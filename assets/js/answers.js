const questions = [{
  ...
  },
  {
    ...
    answers: ["Dihua Marsh", "Wangshu Inn", "Dragonspine"],
    rightAnswer: 1,
  },
  {
    question: "What is the name of your Silver haired flying companion",
    answers: ["Paimon", "Spymon", "Byemon"],
    rightAnswer: 0,
  },
  {
    question: "What element does the traveler acquire first in Teyvat?",
    answers: ["Anemo", "Geo", "Electro"],
    rightAnswer: 0,
  },
  {
    question: "Which island of Inazuma is known for its Aztec-like story theme?",
    answers: ["Yashiori Island", "Watatsumi Island", "Tsurumi Island"],
    rightAnswer: 2,
  },
  {
    question: "What are the demon names of the currently confirmed archons?",
    answers: ["Santa, Rudolf, Satan, George, Frank, Jim", "Barbatos, Morax, Beelzebuul, Buer, Focalors, Murata", "Bermuda, Borax, Baal, Beer, Folklore, Murakami"],
    rightAnswer: 1,
  },
  {
